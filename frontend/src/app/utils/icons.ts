// NOTE: Add this method to AppComponent class in app.component.ts
// getIcon(name: string): string { ... }
// This is extracted here for readability — merge into app.component.ts

export function getIconSvg(name: string): string {
  const icons: Record<string, string> = {
    'grid': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>`,
    'shopping-cart': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 001.77 1.61H19a2 2 0 001.77-1.22L23 6H6"/></svg>`,
